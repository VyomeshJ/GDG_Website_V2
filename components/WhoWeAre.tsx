...
export default function WhoWeAre() {
  return (
    <section data-section="who-we-are" className="relative isolate min-h-[88svh] scroll-mt-24 overflow-hidden bg-white px-[clamp(24px,9vw,140px)] py-[clamp(76px,9vw,120px)] max-[760px]:scroll-mt-22" aria-label="Who we are">
      <div
        ...
        aria-hidden="true"
      />
      <FadeInContent className="relative z-10 grid min-h-[calc(88svh-clamp(152px,18vw,240px))] grid-cols-[minmax(0,1.05fr)_minmax(320px,.95fr)] items-center gap-[clamp(38px,6vw,96px)] max-[760px]:grid-cols-1 max-[760px]:gap-6">
        ...
        <div className="grid place-items-center max-[760px]:order-first"><ScrollArcadeController /></div>
      </FadeInContent>
    </section>
  );
}
